 ...
 */
final class before_first_section_html implements \core\hook\described_hook {
    /**
     * Hook to allow subscribers to add HTML content before the first section.
     *
    ...
    public static function get_hook_description(): string {
        return 'Hook dispatched at the start of rendering the first section in a course.';
    }
    ...
    /**
     * Plugins implementing callback can add any HTML to the top of the first section.
     *
