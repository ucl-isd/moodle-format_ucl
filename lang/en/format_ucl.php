...
$string['coursecontacts:desc'] = 'Select course contacts to show here to students.<br>Hidden contacts will still be visible elsewhere in Moodle.';
...
$string['deletecustomcontact'] = 'Delete {$a}?';
$string['deletecustomcontact:desc'] = 'Are you sure you want to delete this custom contact?';
$string['deletepresetconfirm'] = 'Are you sure you want to delete the section "{$a}"?';
$string['deletesection'] = 'Delete';
$string['deletesuccess'] = '{$a} has been deleted';
...
$string['name'] = 'Name';
$string['name:placeholder'] = 'e.g. Support enquiries';
...
$string['role'] = 'Role';
$string['role:placeholder'] = 'e.g. Course Office';
