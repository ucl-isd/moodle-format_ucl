...
$string['toomanysections:post:desc'] = 'sections. Consider combining related materials into a single section.';
$string['toomanysections:pre:desc'] = 'Courses should have a maximum of ';
