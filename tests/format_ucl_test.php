...
/**
 * UCL course format related unit tests.
 *
 * @package    format_ucl
...
final class format_ucl_test extends \advanced_testcase {
    ...
    /**
     * Tests for format_ucl::get_section_name method with modified section names.
     *
     * @return void
     */
    ...
    /**
     * Tests for format_ucl::get_default_section_name.
     *
     * @return void
     */
    ...
    public function test_update_inplace_editable(): void {
        ...
        $res = \core_external::update_inplace_editable('format_ucl', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable(): void {
        ...
        // Call callback format_ucl_inplace_editable() directly.
        $tmpl = component_callback('format_ucl', 'inplace_editable', ['sectionname', $section->id, 'Rename me again']);
    ...
    public function test_default_course_enddate(): void {
        ...
        $params = ['format' => 'ucl', 'numsections' => 5, 'startdate' => 1445644800];
    ...
    public function test_get_view_url(): void {
        ...
        // When section and/or sr parameter is 0 (first section), the course page should be returned.
        ...
        // When sr parameter is > 0, the section.php page should be returned.
